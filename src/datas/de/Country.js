export const datas = [
  {
    ...
    regions: {
      ...
      items: [
        { id: 1, name: 'Oblast Winnyzja', patch: 'vinnytska', hasInfo: false, svgId: "vinnytsia" },
        { id: 2, name: 'Oblast Wolhynien', patch: 'volynska', hasInfo: false, svgId: "volyn" },
        { id: 3, name: 'Oblast Dnipropetrowsk', patch: 'dnepropetrovska', hasInfo: false, svgId: "dnipropetrovsk" },
        { id: 4, name: 'Oblast Donezk', patch: 'donetska', hasInfo: false, svgId: "donetsk" },
        { id: 5, name: 'Oblast Schytomyr', patch: 'zhytomyrska', hasInfo: false, svgId: "zhytomyr" },
        { id: 6, name: 'Oblast Transkarpatien', patch: 'zakarpatska', hasInfo: false, svgId: "zakarpattia" },
        { id: 7, name: 'Oblast Saporischschja', patch: 'zaporizka', hasInfo: false, svgId: "zaporizhia" },
        { id: 8, name: 'Oblast Iwano-Frankiwsk', patch: 'ivano-frankivska', hasInfo: false, svgId: "ivano-frankivsk" },
        { id: 9, name: 'Oblast Kiew', patch: 'kyivska', hasInfo: false, svgId: "kyiv" },
        { id: 10, name: 'Oblast Kirovohrad', patch: 'kirovohradska', hasInfo: false, svgId: "kirovohrad" },
        { id: 11, name: 'Oblast Luhansk', patch: 'luganska', hasInfo: false, svgId: "luhansk" },
        { id: 12, name: 'Oblast Lwiw', patch: 'lvivska', hasInfo: false, svgId: "lviv" },
        { id: 13, name: 'Oblast Mykolajiw', patch: 'mykolaivska', hasInfo: false, svgId: "mykolaiv" },
        { id: 14, name: 'Oblast Odessa', patch: 'odeska', hasInfo: false, svgId: "odessa" },
        { id: 15, name: 'Oblast Poltawa', patch: 'poltavska', hasInfo: false, svgId: "poltava" },
        { id: 16, name: 'Oblast Riwne', patch: 'rovenska', hasInfo: false, svgId: "rivne" },
        { id: 17, name: 'Oblast Sumy', patch: 'sumska', hasInfo: true, svgId: "sumy" },
        { id: 18, name: 'Oblast Ternopil', patch: 'ternopilska', hasInfo: false, svgId: "ternopil" },
        { id: 19, name: 'Oblast Charkiw', patch: 'kharkivska', hasInfo: false, svgId: "kharkiv" },
        { id: 20, name: 'Oblast Cherson', patch: 'khersonska', hasInfo: false, svgId: "kherson" },
        { id: 21, name: 'Oblast Chmelnyzkyj', patch: 'khmelnytska', hasInfo: false, svgId: "khmelnytskyi" },
        { id: 22, name: 'Oblast Tscherkassy', patch: 'cherkaska', hasInfo: false, svgId: "cherkasy" },
        { id: 23, name: 'Oblast Tschernihiw', patch: 'chernihivska', hasInfo: false, svgId: "chernihiv" },
        { id: 24, name: 'Oblast Tscherniwzi', patch: 'chernivetska', hasInfo: false, svgId: "chernivtsi" },
        { id: 25, name: 'Kiew', patch: 'kyiv', hasInfo: false, svgId: "kyiv-city" },
        { id: 26, name: 'Sewastopol', patch: 'sevastopol', hasInfo: false, svgId: "sevastopol" },
        { id: 27, name: 'Autonome Republik Krim', patch: 'crimea', hasInfo: false, svgId: "crimea" }
      ]
    },
    meta: {
  ...
  },
  {
    ...
    regions: {
      ...
      items: [
        { id: 1, name: 'Baden-Württemberg', hasInfo: false, patch: 'baden-wuerttemberg', svgId: 'bw' },
        { id: 2, name: 'Bayern', hasInfo: false, patch: 'bavaria', svgId: 'by' },
        { id: 3, name: 'Berlin', hasInfo: false, patch: 'berlin', svgId: 'be' },
        { id: 4, name: 'Brandenburg', hasInfo: false, patch: 'brandenburg', svgId: 'bb' },
        { id: 5, name: 'Bremen', hasInfo: false, patch: 'bremen', svgId: 'hb' },
        { id: 6, name: 'Hamburg', hasInfo: false, patch: 'hamburg', svgId: 'hh' },
        { id: 7, name: 'Hessen', hasInfo: false, patch: 'hessen', svgId: 'he' },
        { id: 8, name: 'Mecklenburg-Vorpommern', hasInfo: false, patch: 'mecklenburg-vorpommern', svgId: 'mv' },
        { id: 9, name: 'Niedersachsen', hasInfo: false, patch: 'lower-saxony', svgId: 'ni' },
        { id: 10, name: 'Nordrhein-Westfalen', hasInfo: true, patch: 'nrw', svgId: 'nw' },
        { id: 11, name: 'Rheinland-Pfalz', hasInfo: false, patch: 'rhineland-pfalz', svgId: 'rp' },
        { id: 12, name: 'Saarland', hasInfo: false, patch: 'saarland', svgId: 'sl' },
        { id: 13, name: 'Sachsen', hasInfo: false, patch: 'saxony', svgId: 'sn' },
        { id: 14, name: 'Sachsen-Anhalt', hasInfo: false, patch: 'saxony-anhalt', svgId: 'st' },
        { id: 15, name: 'Schleswig-Holstein', hasInfo: false, patch: 'schleswig-holstein', svgId: 'sh' },
        { id: 16, name: 'Thüringen', hasInfo: false, patch: 'thuringia', svgId: 'th' }
      ]
    },
    meta: {
