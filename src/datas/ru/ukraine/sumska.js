const datas = {
        ...
        items: [
            {
                bold: "Герб:",
                text: [
                    "Элементы герба расположены на геральдическом щите с синим полем и жёлтой окантовкой. Синий цвет рядом с жёлтым издавна традиционен для Сумщины. ",
                    "В синем поле расположен золотой шлем со серебряными деталями, под ним геральдически выгнутый золотой колос с 25 зернышками, слева — золотой охтырский крест. ",
                    "Золотой шлем в верхней части герба символизирует историческое начало наших земель со времён Киевской Руси. ",
                    "Золотой колос, согнутый в виде буквы «С» с 25 зернами, символизирует исторический путь формирования Сумской области, а также хлебопашество — основное занятие жителей и черты характера: трудолюбие, гостеприимность, домовитость, любовь к родной земле. ",
                    "Золотой крест указывает на духовность, которая передаётся из поколения в поколение. ",
                    "Расположение этих элементов под золотым шлемом символизирует готовность и способность жителей области защищать родную землю, духовные и материальные ценности, что на протяжении всей истории проявлялось — от битв с кочевыми племенами до героических страниц Второй мировой войны. ",
                    "Эти три элемента также символизируют три составные части Сумской области: шлем — земли, отошедшие от Черниговской области; колос — земли, отошедшие от Харьковской области; крест — земли, отошедшие от Полтавской области. ",
            ...
            },
            {
                bold: "Флаг:",
                text: [
                    "Флаг Сумской области представляет собой синее полотнище с соотношением ширины к длине 2:3.",
    ...
    briefHistory: {
        ...
        items: [
            ...
            { bold: 'Наши дни:' },
            { text: ' В феврале 2022 года Сумщина одной из первых приняла на себя удар полномасштабного вторжения России. Пограничные города и сёла подверглись ожесточённым обстрелам и разрушениям, многие населённые пункты, расположенные всего в нескольких километрах от границы, оказались почти стёрты с лица земли. Жители были вынуждены покидать свои дома, спасаясь от постоянной угрозы. Несмотря на трагедию и огромные потери, область проявила удивительную стойкость: местные общины сплотились, чтобы выстоять и сохранить жизнь. Эта новейшая страница истории Сумщины стала символом мужества и несокрушимости её народа.' }
        ]
    },
    discriptRegions: [
        {
            title: "Административные районы Сумской области",
            items: [
                { id: 1, name: 'Ахтырский', hasInfo: false, path: "akhtyrka" },
                { id: 2, name: 'Конотопcкий', hasInfo: false, path: "konotop" },
                { id: 3, name: 'Роменский', hasInfo: false, path: "romny" },
                { id: 4, name: 'Сумской', hasInfo: false, path: "sumy" },
                { id: 5, name: 'Шосткинский', hasInfo: false, path: "shostka" }
            ]
        }
    ],
    meta: {
