    ...
    },
    {
        ...
        interestingFacts: {
            ...
            items: [
                ...
                { text: 'В музее Keramion представлена уникальная коллекция керамики и современного искусства, а само здание музея считается архитектурным шедевром модернизма.' },
        ...
        briefHistory: {
            ...
            items: [
                ...
                { text: '2 сентября 1951 года Фрехен получил официальный статус города (Stadtrechte).' },
