export const datas = [
  {
    ...
    desc: {
      ...
      cuisine: [
        { bold: 'Кухня:' },
        { text: ' визитная карточка страны — борщ с пампушками, различные котлеты, печеня, битки, голубцы, шашлык, сало. Подробнее о традиционных блюдах можно прочитать ' },
        { link: { text: 'здесь', url: 'https://ukraine.ua/ru' } },
        { text: '.' }
      ],
      entry: [
