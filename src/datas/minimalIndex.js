...

{
  ...
  attractions: {
    ...
    ehrenmal_langscheid: { ru: 'Мемориал Лангшайд', de: 'Ehrenmal Langscheid', ua: 'Меморіал Лангшайд' },
    ...
    decksteiner_weiher_koln: { ru: 'Озеро Декштайнер Вайер', de: 'Decksteiner Weiher', ua: 'Озеро Декштайнер Вайер' },
    ...
    rumerturm_koln: { ru: 'Римская башня Römerturm', de: 'Römerturm', ua: 'Римська вежа Römerturm' },
    hahnentorburg_koln: { ru: 'Западные ворота (Hahnentorburg)', de: 'Hahnentorburg (Westtor)', ua: 'Західні ворота (Hahnentorburg)' },
    eigelsteintorburg_koln: { ru: 'Северные ворота (Eigelsteintorburg)', de: 'Eigelsteintorburg (Nordtor)', ua: 'Північні ворота (Eigelsteintorburg)' },
    severinstorburg_koln: { ru: 'Южные ворота (Severinstorburg)', de: 'Severinstorburg (Südtor)', ua: 'Південні ворота (Severinstorburg)' },
    ulrepforte_koln: { ru: 'Южные малые ворота (Ulrepforte)', de: 'Ulrepforte (kleines Südtor)', ua: 'Південні малі ворота (Ulrepforte)' },
    bayenturm_koln: { ru: 'Юго-восточная башня у Рейна (Bayenturm)', de: 'Bayenturm (Südostturm am Rhein)', ua: 'Південно-східна вежа біля Рейну (Bayenturm)' },
    ...
    hauptmarkt_trier: { ru: 'Главная рыночная площадь', de: 'Hauptmarkt', ua: 'Головна ринкова площа' },
