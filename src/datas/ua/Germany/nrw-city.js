const datas = [
    ...
    notablePeople: {
        ...
        items: {
            1: [
                { bold: 'Конрад Аденауер' },
                { text: ' – перший канцлер ФРН, у 1917–1933 роках обіймав посаду обер-бургомістра Кельна.' }
            ],
            2: [
                { bold: 'Ніколаус Август Отто' },
                { text: ' – інженер, винахідник першого двигуна внутрішнього згоряння (1874), співзасновник заводу Kloeckner Humboldt Deutz AG.' }
            ],
            3: [
                { bold: 'Георг Сімон Ом' },
                { text: ' – фізик, відкрив закон електричного опору (1827), викладав у Кельні.' }
            ],
            4: [
                { bold: 'Август Зандер' },
                { text: ' – фотограф, автор серії «Люди XX століття».' }
            ],
            5: [
                { bold: 'Карлхайнц Штокхаузен' },
                { text: ' – композитор, один із піонерів електронної музики, працював у студії WDR.' }
            ],
            6: [
                { bold: 'Макс Ернст' },
                { text: ' – художник-сюрреаліст, народився у Кельні.' }
            ],
            7: [
                { bold: 'Генріх Бьолль' },
                { text: ' – письменник, лауреат Нобелівської премії з літератури (1972), жив і працював у Кельні.' }
            ],
            8: [
                { bold: 'Ґюнтер Ґрасс' },
                { text: ' – письменник, лауреат Нобелівської премії з літератури (1999), частину життя був пов’язаний із Кельном.' }
            ]
        }
    },
    interestingFacts: {
