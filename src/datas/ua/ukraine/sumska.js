const datas = {
    ...
    briefHistory: {
        ...
        items: [
            ...
            { bold: 'Наші дні:' },
            { text: ' У лютому 2022 року Сумщина однією з перших прийняла на себе удар повномасштабного вторгнення Росії. Прикордонні міста та села зазнали жорстоких обстрілів і руйнувань, багато населених пунктів, розташованих всього за кілька кілометрів від кордону, опинилися майже стерті з лиця землі. Жителі були змушені покидати свої домівки, рятуючись від постійної загрози. Незважаючи на трагедію та величезні втрати, область проявила дивовижну стійкість: місцеві громади об’єдналися, щоб вистояти та зберегти життя. Ця новітня сторінка історії Сумщини стала символом мужності та незламності її народу.' }
        ]
    },
    discriptRegions: [
        {
            title: "Адміністративні райони Сумської області",
            items: [
                { id: 1, name: 'Ахтирський', hasInfo: false, path: "akhtyrka" },
                { id: 2, name: 'Конотопський', hasInfo: false, path: "konotop" },
                { id: 3, name: 'Роменський', hasInfo: false, path: "romny" },
                { id: 4, name: 'Сумський', hasInfo: false, path: "sumy" },
                { id: 5, name: 'Шосткинський', hasInfo: false, path: "shostka" }
            ]
        }
    ],
    meta: {
