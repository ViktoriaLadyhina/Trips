    ...
    // Märkischer Kreis
    {
        ...
        translations: {
            ru: {
                ...
                admin: {
                    title: 'Город Люденшайд разделён на 16 статистических районов (Stadtteile):',
                    isList: true,
                    items: [
                        { bold: 'Innenstadt / Staberg / Knapp', text: '– центральная часть города с административными зданиями, торговыми улицами и вокзалом.' },
                        { bold: 'Tinsberg / Kluse', text: '– городской район с жилой застройкой, расположенный рядом с центром.' },
                        { bold: 'Grünewald', text: '– жилой район недалеко от центра города.' },
                        { bold: 'Honsel / Eichholz', text: '– северо-восточная часть города с жилыми и промышленными зонами.' },
                        { bold: 'Oeneking / Stüttinghausen', text: '– район с жилой застройкой и смешанной инфраструктурой.' },
                        { bold: 'Buckesfeld / Othlinghausen', text: '– крупный современный жилой район.' },
                        { bold: 'Wehberg', text: '– восточный жилой район города.' },
                        { bold: 'Kalve / Wefelshohl', text: '– район на окраине с жилой застройкой и переходом в сельскую зону.' },
                        { bold: 'Gevelndorf / Freisenberg', text: '– северная часть города с жилыми кварталами.' },
                        { bold: 'Brüninghausen / Augustenthal', text: '– периферийный район в долине с природным окружением.' },
                        { bold: 'Bierbaum / Höh / Hellersen', text: '– южные и пригородные территории с разреженной застройкой.' },
                        { bold: 'Brügge', text: '– исторически сформированный район на северо-западе города.' },
                        { bold: 'Ramsberg / Hasley / Baukloh', text: '– смешанный район с жилыми зонами и окраинами города.' },
                        { bold: 'Vogelberg', text: '– более удалённый жилой район в пригородной зоне.' },
                        { bold: 'Wettringhof', text: '– южный район рядом с зелёными и природными территориями.' },
                        { bold: 'Dickenberg / Eggenscheid', text: '– периферийный район с жилой застройкой и природным окружением.' }
                    ]
                },
                notablePeople: {
            ...
            ua: {
                ...
                admin: {
                    title: 'Місто Люденшайд поділене на 16 статистичних районів (Stadtteile):',
                    isList: true,
                    items: [
                        { bold: 'Innenstadt / Staberg / Knapp', text: '– центральна частина міста з адміністративними будівлями, торговими вулицями та вокзалом.' },
                        { bold: 'Tinsberg / Kluse', text: '– міський район із житловою забудовою, розташований поруч із центром.' },
                        { bold: 'Grünewald', text: '– житловий район неподалік від центру міста.' },
                        { bold: 'Honsel / Eichholz', text: '– північно-східна частина міста з житловими та промисловими зонами.' },
                        { bold: 'Oeneking / Stüttinghausen', text: '– район із житловою забудовою та змішаною інфраструктурою.' },
                        { bold: 'Buckesfeld / Othlinghausen', text: '– великий сучасний житловий район.' },
                        { bold: 'Wehberg', text: '– східний житловий район міста.' },
                        { bold: 'Kalve / Wefelshohl', text: '– район на околиці з житловою забудовою та переходом у сільську зону.' },
                        { bold: 'Gevelndorf / Freisenberg', text: '– північна частина міста з житловими кварталами.' },
                        { bold: 'Brüninghausen / Augustenthal', text: '– периферійний район у долині з природним оточенням.' },
                        { bold: 'Bierbaum / Höh / Hellersen', text: '– південні та приміські території з розрідженою забудовою.' },
                        { bold: 'Brügge', text: '– історично сформований район на північному заході міста.' },
                        { bold: 'Ramsberg / Hasley / Baukloh', text: '– змішаний район із житловими зонами та околицями міста.' },
                        { bold: 'Vogelberg', text: '– більш віддалений житловий район у приміській зоні.' },
                        { bold: 'Wettringhof', text: '– південний район поруч із зеленими та природними територіями.' },
                        { bold: 'Dickenberg / Eggenscheid', text: '– периферійний район із житловою забудовою та природним оточенням.' }
                    ]
                },
                geography: {
            ...
            de: {
                ...
                admin: {
                    title: 'Die Stadt Lüdenscheid ist in 16 statistische Stadtteile unterteilt:',
                    isList: true,
                    items: [
                        { bold: 'Innenstadt / Staberg / Knapp', text: '– zentraler Stadtbereich mit Verwaltungsgebäuden, Einkaufsstraßen und Bahnhof.' },
                        { bold: 'Tinsberg / Kluse', text: '– Wohngebiet in Stadtnähe mit dichter Bebauung.' },
                        { bold: 'Grünewald', text: '– Wohngebiet in der Nähe des Stadtzentrums.' },
                        { bold: 'Honsel / Eichholz', text: '– nordöstlicher Stadtbereich mit Wohn- und Industriegebieten.' },
                        { bold: 'Oeneking / Stüttinghausen', text: '– Gebiet mit Wohnbebauung und gemischter Infrastruktur.' },
                        { bold: 'Buckesfeld / Othlinghausen', text: '– großes modernes Wohngebiet.' },
                        { bold: 'Wehberg', text: '– östlicher Wohnstadtteil.' },
                        { bold: 'Kalve / Wefelshohl', text: '– Randgebiet mit Wohnbebauung und Übergang zum ländlichen Raum.' },
                        { bold: 'Gevelndorf / Freisenberg', text: '– nördlicher Stadtbereich mit Wohnvierteln.' },
                        { bold: 'Brüninghausen / Augustenthal', text: '– peripherer Stadtteil im Tal mit natürlicher Umgebung.' },
                        { bold: 'Bierbaum / Höh / Hellersen', text: '– südliche und stadtrandnahe Gebiete mit lockerer Bebauung.' },
                        { bold: 'Brügge', text: '– historisch gewachsener Stadtteil im Nordwesten.' },
                        { bold: 'Ramsberg / Hasley / Baukloh', text: '– gemischtes Gebiet mit Wohnzonen und Stadtrandlagen.' },
                        { bold: 'Vogelberg', text: '– weiter außerhalb gelegener Wohnbereich im Umland.' },
                        { bold: 'Wettringhof', text: '– südlicher Stadtteil nahe Grün- und Naturflächen.' },
                        { bold: 'Dickenberg / Eggenscheid', text: '– peripherer Bereich mit Wohnbebauung und Naturumgebung.' }
                    ]
                },
                geography: {
    ...
    },
    {
        ...
        translations: {
            ru: {
                ...
                admin: {
                    title: 'Ломар разделён на 30 официальных городских частей (Stadtteile) и множество небольших деревень и поселений. Ниже приведены крупнейшие из них:',
                    isList: true,
                    items: [
                        {
                            bold: 'Lohmar (Lohmar-Ort)',
                            text: '– центральная часть города с административными учреждениями, магазинами и основной инфраструктурой (включает: Kirchdorf, Auelsweg, Algert)'
                        },
                        {
                            bold: 'Wahlscheid',
                            text: '– крупный жилой и природный район с деревенской структурой и активной локальной жизнью (включает: Aggertal, Höffen, Weeg, Scheid, Wahlscheiderhöhe)'
                        },
                        {
                            bold: 'Birk',
                            text: '– современный жилой район с новыми кварталами, школами и развитой инфраструктурой (включает: Heide, Birkerhöhe, Albach)'
                        },
                        {
                            bold: 'Donrath',
                            text: '– район в долине реки Аггер с жилой застройкой и хорошим транспортным сообщением (включает: Oberschönrath, Niederscheiderberg, Scheiderhöhe (частично))'
                        },
                        {
                            bold: 'Honrath',
                            text: '– сельский и исторический район с традиционной застройкой и природным окружением (включает: Hausen, Wickuhl, Höngesberg, Neuhonrath)'
                        },
                        {
                            bold: 'Breidt',
                            text: '– сельский район с фермерскими хозяйствами и природным ландшафтом (включает: Dahlhaus, Halberg)'
                        },
                        {
                            bold: 'Sülztal',
                            text: '– долина реки Sülz с природными зонами и разрозненными поселениями (включает: Krahwinkel, Müllenbach, Weegen, Wielpütz)'
                        },
                        {
                            bold: 'Scheiderhöhe',
                            text: '– сельский холмистый район с фермерскими хозяйствами и открытыми ландшафтами (включает: Pipenmühle, Oberschönrath)'
                        },
                        {
                            bold: 'Hoven',
                            text: '– небольшой жилой и сельский район с разреженной застройкой (включает: отдельные хутора и фермерские дома)'
                        },
                        {
                            bold: 'Lohmarhohn',
                            text: '– небольшое возвышенное поселение с частной застройкой (включает: прилегающие хутора)'
                        }
                    ]
                },
                geography: {
            ...
            ua: {
                ...
                admin: {
                    title: 'Ломар поділений на 30 офіційних міських частин (Stadtteile) та численні невеликі села і поселення. Нижче наведені найбільші з них:',
                    isList: true,
                    items: [
                        {
                            bold: 'Lohmar (Lohmar-Ort)',
                            text: '– центральна частина міста з адміністративними установами, магазинами та основною інфраструктурою (включає: Kirchdorf, Auelsweg, Algert)'
                        },
                        {
                            bold: 'Wahlscheid',
                            text: '– великий житловий і природний район із сільською структурою та активним локальним життям (включає: Aggertal, Höffen, Weeg, Scheid, Wahlscheiderhöhe)'
                        },
                        {
                            bold: 'Birk',
                            text: '– сучасний житловий район із новими кварталами, школами та розвиненою інфраструктурою (включає: Heide, Birkerhöhe, Albach)'
                        },
                        {
                            bold: 'Donrath',
                            text: '– район у долині річки Аггер із житловою забудовою та зручним транспортним сполученням (включає: Oberschönrath, Niederscheiderberg, Scheiderhöhe (частково))'
                        },
                        {
                            bold: 'Honrath',
                            text: '– сільський і історичний район із традиційною забудовою та природним оточенням (включає: Hausen, Wickuhl, Höngesberg, Neuhonrath)'
                        },
                        {
                            bold: 'Breidt',
                            text: '– сільський район із фермерськими господарствами та природним ландшафтом (включає: Dahlhaus, Halberg)'
                        },
                        {
                            bold: 'Sülztal',
                            text: '– долина річки Sülz із природними зонами та розрізненими поселеннями (включає: Krahwinkel, Müllenbach, Weegen, Wielpütz)'
                        },
                        {
                            bold: 'Scheiderhöhe',
                            text: '– сільський пагорбовий район із фермерськими господарствами та відкритими ландшафтами (включає: Pipenmühle, Oberschönrath)'
                        },
                        {
                            bold: 'Hoven',
                            text: '– невеликий житловий і сільський район із розрідженою забудовою (включає: окремі хутори та фермерські будинки)'
                        },
                        {
                            bold: 'Lohmarhohn',
                            text: '– невелике підвищене поселення з приватною забудовою (включає: прилеглі хутори)'
                        }
                    ]
                },
                geography: {
            ...
            de: {
                ...
                admin: {
                    title: 'Lohmar ist in 30 offizielle Stadtteile (Stadtteile) sowie zahlreiche kleine Dörfer und Siedlungen unterteilt. Nachfolgend sind die größten davon aufgeführt:',
                    isList: true,
                    items: [
                        {
                            bold: 'Lohmar (Lohmar-Ort)',
                            text: '– zentraler Stadtteil mit Verwaltungsgebäuden, Geschäften und grundlegender Infrastruktur (einschließlich: Kirchdorf, Auelsweg, Algert)'
                        },
                        {
                            bold: 'Wahlscheid',
                            text: '– großer Wohn- und Naturraum mit dörflicher Struktur und aktivem lokalen Leben (einschließlich: Aggertal, Höffen, Weeg, Scheid, Wahlscheiderhöhe)'
                        },
                        {
                            bold: 'Birk',
                            text: '– moderner Wohnstadtteil mit neuen Wohnvierteln, Schulen und gut ausgebauter Infrastruktur (einschließlich: Heide, Birkerhöhe, Albach)'
                        },
                        {
                            bold: 'Donrath',
                            text: '– Stadtteil im Aggertal mit Wohnbebauung und guter Verkehrsanbindung (einschließlich: Oberschönrath, Niederscheiderberg, Scheiderhöhe (teilweise))'
                        },
                        {
                            bold: 'Honrath',
                            text: '– ländlicher und historischer Stadtteil mit traditioneller Bebauung und natürlicher Umgebung (einschließlich: Hausen, Wickuhl, Höngesberg, Neuhonrath)'
                        },
                        {
                            bold: 'Breidt',
                            text: '– ländlicher Stadtteil mit landwirtschaftlichen Betrieben und naturnaher Landschaft (einschließlich: Dahlhaus, Halberg)'
                        },
                        {
                            bold: 'Sülztal',
                            text: '– Tal der Sülz mit Naturgebieten und verstreuten Siedlungen (einschließlich: Krahwinkel, Müllenbach, Weegen, Wielpütz)'
                        },
                        {
                            bold: 'Scheiderhöhe',
                            text: '– ländlicher Höhenstadtteil mit landwirtschaftlichen Betrieben und offenen Landschaften (einschließlich: Pipenmühle, Oberschönrath)'
                        },
                        {
                            bold: 'Hoven',
                            text: '– kleiner Wohn- und ländlicher Stadtteil mit lockerer Bebauung (einschließlich: einzelne Höfe und Bauernhäuser)'
                        },
                        {
                            bold: 'Lohmarhohn',
                            text: '– kleine Siedlung auf einer Anhöhe mit Wohnbebauung (einschließlich: angrenzende Höfe)'
                        }
                    ]
                },
                geography: {
