        ...
        translations: {
            ru: {
                ...
                communities: [
                    ...
                    { id: 4, name: "Изерлон", hasInfo: true, path: "iserlohn" },
        ...
        translations: {
            ru: {
                ...
                communities: [
                    ...
                    { id: 5, name: "Зундерн", hasInfo: true, path: "sundern" },
            ...
            de: {
                ...
                communities: [
                    ...
                    { id: 5, name: "Sundern", hasInfo: true, path: "sundern" },
        ...
        translations: {
            ru: {
                ...
                communities: [
                    ...
                    { id: 9, name: "Ломар", hasInfo: true, path: "lohmar" },
            ...
            ua: {
                ...
                communities: [
                    ...
                    { id: 9, name: "Ломмар", hasInfo: true, path: "lohmar" },
                    { id: 10, name: "Меккенхайм", hasInfo: false },
                    { id: 11, name: "Мух", hasInfo: false },
            ...
            de: {
                ...
                communities: [
                    ...
                    { id: 9, name: "Lohmar", hasInfo: true, path: "lohmar" },
