    ...
    // Люксембург
    {
        ...
        translations: {
            ru: {
                ...
                admin: {
                    title: 'Город Люксембург разделён на 24 городских квартала (quartiers):',
                    isList: true,
                    items: [
                        { bold: 'Ville Haute', text: '– исторический центр города, расположенный на плато. Здесь находятся главные площади, государственные учреждения, соборы и старинные улицы.' },
                        { bold: 'Gare', text: '– район вокруг центрального железнодорожного вокзала. Важный транспортный и коммерческий узел города с отелями и офисами.' },
                        { bold: 'Grund', text: '– живописный нижний город в долине реки Альзет. Известен исторической застройкой, мостами и культурными пространствами.' },
                        { bold: 'Clausen', text: '– район с барами, ресторанами и ночной жизнью, расположенный рядом с историческим центром.' },
                        { bold: 'Pfaffenthal', text: '– старинный район в долине, соединяющий нижний и верхний город, известен мостами и панорамными видами.' },
                        { bold: 'Limpertsberg', text: '– престижный жилой район с университетом, школами и культурными учреждениями.' },
                        { bold: 'Belair', text: '– тихий жилой район с зелёными зонами и удобной инфраструктурой.' },
                        { bold: 'Merl', text: '– спокойный жилой квартал с парками и современными жилыми домами.' },
                        { bold: 'Cessange', text: '– активно развивающийся район с новыми жилыми кварталами и коммерческими зонами.' },
                        { bold: 'Hollerich', text: '– смешанный район с жилой застройкой, офисами и промышленными зонами, постепенно обновляется.' },
                        { bold: 'Bonnevoie', text: '– один из крупнейших жилых районов города, делится на Bonnevoie-Nord и Bonnevoie-Sud.' },
                        { bold: 'Kirchberg', text: '– современный деловой район с европейскими институтами, банками и музеями.' },
                        { bold: 'Neudorf/Weimershof', text: '– жилой район между центром и Кирхбергом, активно застраивается.' },
                        { bold: 'Cents', text: '– спокойный жилой район на востоке города с семейной атмосферой.' },
                        { bold: 'Pulvermühl', text: '– небольшой район в долине с жилой застройкой.' },
                        { bold: 'Verlorenkost', text: '– небольшой исторический район рядом с центром и вокзалом.' },
                        { bold: 'Weimerskirch', text: '– жилой район на севере города с холмистым рельефом.' },
                        { bold: 'Beggen', text: '– тихий северный район с жилыми домами и зелёными зонами.' },
                        { bold: 'Eich', text: '– район на севере города с промышленными и жилыми зонами.' },
                        { bold: 'Mühlenbach', text: '– жилой район рядом с долиной и зелёными территориями.' },
                        { bold: 'Rollingergrund / Belair-Nord', text: '– район с природными зонами и жилой застройкой.' },
                        { bold: 'Dommeldange', text: '– северный жилой район с холмами и современными домами.' },
                        { bold: 'Fetschenhof', text: '– небольшой район рядом с Кирхбергом, в основном жилой.' },
                        { bold: 'Kockelscheuer', text: '– район на юге города с природными зонами, спортом и выставочными площадками.' },
                    ]
                },
                geography: {
            ...
            ua: {
                ...
                admin: {
                    title: 'Місто Люксембург поділене на 24 міських квартали (quartiers):',
                    isList: true,
                    items: [
                        { bold: 'Ville Haute', text: '– історичний центр міста, розташований на плато. Тут знаходяться головні площі, державні установи, собори та старовинні вулиці.' },
                        { bold: 'Gare', text: '– район навколо центрального залізничного вокзалу. Важливий транспортний і комерційний вузол міста з готелями та офісами.' },
                        { bold: 'Grund', text: '– мальовниче нижнє місто в долині річки Альзет. Відоме історичною забудовою, мостами та культурними просторами.' },
                        { bold: 'Clausen', text: '– район із барами, ресторанами та нічним життям, розташований поруч з історичним центром.' },
                        { bold: 'Pfaffenthal', text: '– старовинний район у долині, що з’єднує нижнє та верхнє місто, відомий мостами та панорамними видами.' },
                        { bold: 'Limpertsberg', text: '– престижний житловий район з університетом, школами та культурними установами.' },
                        { bold: 'Belair', text: '– тихий житловий район із зеленими зонами та зручною інфраструктурою.' },
                        { bold: 'Merl', text: '– спокійний житловий квартал із парками та сучасними житловими будинками.' },
                        { bold: 'Cessange', text: '– активно розвивається район із новими житловими кварталами та комерційними зонами.' },
                        { bold: 'Hollerich', text: '– змішаний район із житловою забудовою, офісами та промисловими зонами, що поступово оновлюється.' },
                        { bold: 'Bonnevoie', text: '– один із найбільших житлових районів міста, поділяється на Bonnevoie-Nord і Bonnevoie-Sud.' },
                        { bold: 'Kirchberg', text: '– сучасний діловий район з європейськими інституціями, банками та музеями.' },
                        { bold: 'Neudorf/Weimershof', text: '– житловий район між центром і Кирхбергом, активно забудовується.' },
                        { bold: 'Cents', text: '– спокійний житловий район на сході міста з сімейною атмосферою.' },
                        { bold: 'Pulvermühl', text: '– невеликий район у долині з житловою забудовою.' },
                        { bold: 'Verlorenkost', text: '– невеликий історичний район поруч із центром і вокзалом.' },
                        { bold: 'Weimerskirch', text: '– житловий район на півночі міста з горбистим рельєфом.' },
                        { bold: 'Beggen', text: '– тихий північний район із житловими будинками та зеленими зонами.' },
                        { bold: 'Eich', text: '– район на півночі міста з промисловими та житловими зонами.' },
                        { bold: 'Mühlenbach', text: '– житловий район поруч із долиною та зеленими територіями.' },
                        { bold: 'Rollingergrund / Belair-Nord', text: '– район із природними зонами та житловою забудовою.' },
                        { bold: 'Dommeldange', text: '– північний житловий район із пагорбами та сучасними будинками.' },
                        { bold: 'Fetschenhof', text: '– невеликий район поруч із Кирхбергом, переважно житловий.' },
                        { bold: 'Kockelscheuer', text: '– район на півдні міста з природними зонами, спортом і виставковими майданчиками.' },
                    ]
                },
                geography: {
            ...
            de: {
                ...
                admin: {
                    title: 'Die Stadt Luxemburg ist in 24 Stadtviertel (quartiers) unterteilt:',
                    isList: true,
                    items: [
                        { bold: 'Ville Haute', text: '– historisches Stadtzentrum auf dem Plateau. Hier befinden sich die wichtigsten Plätze, staatlichen Einrichtungen, Kathedralen und alte Straßen.' },
                        { bold: 'Gare', text: '– Viertel rund um den Hauptbahnhof. Wichtiger Verkehrs- und Handelsknotenpunkt der Stadt mit Hotels und Büros.' },
                        { bold: 'Grund', text: '– malerische Unterstadt im Alzette-Tal. Bekannt für historische Bebauung, Brücken und kulturelle Räume.' },
                        { bold: 'Clausen', text: '– Viertel mit Bars, Restaurants und Nachtleben in der Nähe des historischen Zentrums.' },
                        { bold: 'Pfaffenthal', text: '– historisches Talviertel, das Ober- und Unterstadt verbindet, bekannt für Brücken und Panoramablicke.' },
                        { bold: 'Limpertsberg', text: '– gehobenes Wohnviertel mit Universität, Schulen und kulturellen Einrichtungen.' },
                        { bold: 'Belair', text: '– ruhiges Wohnviertel mit Grünflächen und guter Infrastruktur.' },
                        { bold: 'Merl', text: '– ruhiges Wohnviertel mit Parks und modernen Wohngebäuden.' },
                        { bold: 'Cessange', text: '– sich dynamisch entwickelndes Viertel mit neuen Wohngebieten und Gewerbeflächen.' },
                        { bold: 'Hollerich', text: '– gemischtes Viertel mit Wohn-, Büro- und Industriegebieten, das sich schrittweise erneuert.' },
                        { bold: 'Bonnevoie', text: '– eines der größten Wohnviertel der Stadt, unterteilt in Bonnevoie-Nord und Bonnevoie-Sud.' },
                        { bold: 'Kirchberg', text: '– modernes Geschäftsviertel mit europäischen Institutionen, Banken und Museen.' },
                        { bold: 'Neudorf/Weimershof', text: '– Wohnviertel zwischen Zentrum und Kirchberg, das stark ausgebaut wird.' },
                        { bold: 'Cents', text: '– ruhiges Wohnviertel im Osten der Stadt mit familiärer Atmosphäre.' },
                        { bold: 'Pulvermühl', text: '– kleines Wohnviertel im Talgebiet.' },
                        { bold: 'Verlorenkost', text: '– kleines historisches Viertel nahe Zentrum und Bahnhof.' },
                        { bold: 'Weimerskirch', text: '– Wohnviertel im Norden der Stadt mit hügeligem Relief.' },
                        { bold: 'Beggen', text: '– ruhiges nördliches Wohnviertel mit Häusern und Grünflächen.' },
                        { bold: 'Eich', text: '– Stadtviertel im Norden mit Industrie- und Wohngebieten.' },
                        { bold: 'Mühlenbach', text: '– Wohnviertel nahe dem Tal und Grünflächen.' },
                        { bold: 'Rollingergrund / Belair-Nord', text: '– Viertel mit Naturgebieten und Wohnbebauung.' },
                        { bold: 'Dommeldange', text: '– nördliches Wohnviertel mit Hügeln und modernen Häusern.' },
                        { bold: 'Fetschenhof', text: '– kleines Viertel nahe Kirchberg, überwiegend Wohngebiet.' },
                        { bold: 'Kockelscheuer', text: '– südliches Stadtviertel mit Naturflächen, Sportanlagen und Messegeländen.' },
                    ]
                },
                geography: {
