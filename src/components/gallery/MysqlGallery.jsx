...
const MysqlGallery = ({ images, lang }) => {
        ...
        <div className="gallery">
            ...
            <div className="gallery__main-wrapper">
                ...
                <div className="gallery__image-container">
                    <img
                        src={`${BASE_PHOTO_URL}${images[current]?.path}`}
                        alt={images[current]?.title?.[lang] || ""}
                        className="gallery__image"
                    />
                    <div className="gallery__caption">{images[current]?.title?.[lang] || ""}</div>
                </div>
